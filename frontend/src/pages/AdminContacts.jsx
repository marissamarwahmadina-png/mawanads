...
import { Mail, Phone, Building, Calendar, User, MessageSquare, RefreshCw, LogOut } from 'lucide-react';
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                Data Kontak Submissions
              </h1>
              <p className="text-gray-600">
                Total: <span className="font-semibold text-cyan-600">{contacts.length}</span> submission
              </p>
            </div>
            ...
            <Card key={contact.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  {contact.organization && (
                    <div className="flex items-start space-x-3">
                      <Building className="text-cyan-600 flex-shrink-0 mt-1" size={20} />
                      <div>
                        <p className="text-sm text-gray-500 mb-1">Organisasi/Brand</p>
                        <p className="text-gray-900 font-medium">{contact.organization}</p>
                      </div>
                    </div>
                  )}
                </div>
