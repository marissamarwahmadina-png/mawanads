...
class ContactFormTester:
    ...
    def test_empty_name_validation(self):
        ...
        try:
            ...
            if response.status_code == 400:
                self.log_result(test_name, True, "Correctly rejected empty name with 400 error")
            else:
    ...
    def test_empty_message_validation(self):
        ...
        try:
            ...
            if response.status_code == 400:
                self.log_result(test_name, True, "Correctly rejected empty message with 400 error")
            else:
                self.log_result(test_name, False, f"Expected 400 error, got {response.status_code}: {response.text}")
