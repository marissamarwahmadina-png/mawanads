...
export const FloatingWhatsApp = () => {
  ...
  return (
    ...
    >
      {/* WhatsApp Button dengan logo WhatsApp */}
      <div className="relative">
        {/* WhatsApp Circle dengan Logo */}
        <div 
          className="w-16 h-16 md:w-20 md:h-20 rounded-full shadow-2xl flex items-center justify-center"
          style={{
